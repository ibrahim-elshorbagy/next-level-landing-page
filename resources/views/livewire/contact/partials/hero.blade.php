<section class="relative min-h-[60vh] flex items-center justify-center overflow-hidden">
  ...
  <div class="absolute inset-0">
    <img src="{{ asset('assets/contact/ContactHero.webp') }}"
      alt="Contact NEXT LEVEL - Get in touch for consulting services" class="w-full h-full object-cover"
  ...
  <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-24 md:py-32 text-center">
    <div class="max-w-4xl mx-auto">
      ...
      <div
        ...
        <x-heroicon-o-envelope class="w-4 h-4 sm:w-5 sm:h-5 text-accent mr-2" />
        <span class="text-white/80 text-xs sm:text-sm font-medium">Get in Touch</span>
      </div>
      ...
      <h1
        ...
        <span class="inline-flex items-center justify-center flex-wrap gap-2 sm:gap-3">
          ...
          <span>Let's Build Something <span class="text-accent">Together</span></span>
        </span>
      </h1>

      <!-- Subheading -->
      <p class="text-base sm:text-lg md:text-xl lg:text-2xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
        Whether you're scaling internationally, repositioning your brand, or unlocking institutional growth—NEXT LEVEL
        CONSULTING is here to support your journey.
      </p>
    </div>
  </div>

  <!-- Bottom Gradient -->
  <div class="absolute bottom-0 left-0 right-0 h-24 sm:h-32 bg-gradient-to-t from-gray-50 to-transparent"></div>
</section>
